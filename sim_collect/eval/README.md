...
> Ubuntu 24.04 / ROS 2 Jazzy에서는 먼저 [`../UBUNTU24_JAZZY_MIGRATION.md`](../UBUNTU24_JAZZY_MIGRATION.md)를
> 따른다. 진단 MP4 생성에는 시스템 `ffmpeg`(`libx264`)가 필요하다.
...
| FM 100k (last, Euler 10스텝, CPU) | – | 10/20 | – |
