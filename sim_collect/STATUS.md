...
| sim Diffusion | 🔄 kanu GPU 0에서 진행 중(100k, 10k마다 저장, ~16:40 종료) | 10k 0/10 · 20k 1/10 · 30k 12 · 40k 10 · 50k 7 · 60k 9 · **70k 13/20**(최고) — 30k 이후 ±20 % 구간 안 등락, 과적합 신호 아님 |
| sim Flow-Matching | 🔄 kanu GPU 1에서 진행 중(100k, ~20:40 종료) | 10k 4 · 20k 7 · 30k 4 (/20; CPU, Euler 10스텝 — 실기 서버 기본 100스텝과 다름) · 이후 나오는 대로 |
