...
자동 측정하는 평가 하네스**를 만들어 첫 모델(sim ACT)의 held-out SR을 쟀다. 세 계열(ACT/Diffusion/FM) 학습과 전 체크포인트
SR 측정이 끝났고, 60 seed 최종 순위는 Diffusion 70k = FM 80k 55 %, ACT 50k 42 %다.
...
| sim Flow-Matching | ✅ 100k 종료(9h53m) | 10k 4 · 20k 7 · 30k 4 · 40k 6 · 50k 9 · 60k 7 · **70k 11** · **80k 11** · 90k 10 · 100k 10 (/20; CPU, Euler 10스텝 — 실기 서버 기본 100스텝과 다름) |
...
1. ✅ 세 계열 전 체크포인트 SR 측정 완료(2026-09-15 21:30).
2. **최종 순위(새 seed 120~159 추가, 총 60 seed)**: Diffusion 70k **33/60 (55 %)** · FM 80k **33/60 (55 %)** · ACT 50k 25/60 (42 %) —
   Diffusion·FM이 동률로 앞서고 ACT가 뒤진다(Wilson 95 % 각각 42~67 % / 30~55 %). FM 90k·100k는 20 seed로 잰 뒤 더 좋으면 60 seed로 재확인.
