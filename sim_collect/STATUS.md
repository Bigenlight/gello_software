...
| sim Diffusion | 🔄 kanu GPU 0에서 진행 중(100k, 10k마다 저장, ~17:30 종료) | 10k 0/10 · 20k 1/10 · **30k 12/20**(최고) · 40k 10/20 · 50k 7/20(하락 — 22 에피소드로는 30k 이후 과적합 의심, eval_loss 상승과 일치) |
| sim Flow-Matching | 🔄 kanu GPU 1에서 진행 중(100k, ~20:40 종료) | 10k 4/20 · 20k 7/20 (CPU, Euler 10스텝 — 실기 서버 기본 100스텝과 다름) · 이후 나오는 대로 |
...
1. Diffusion·FM 체크포인트 SR 측정(자동, 알림 오는 대로). Diffusion은 30k 이후 하락 추세라 60k·70k도 떨어지면 **조기 종료 여부 결정 필요**.
