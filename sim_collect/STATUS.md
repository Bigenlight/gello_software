...
| sim Diffusion | 🔄 kanu GPU 0에서 진행 중(100k, 10k마다 저장, ~16:20 종료) | 10k 0/10 · 20k 1/10 · **30k 12/20**(현재 최고) · 40k 10/20 · 이후 나오는 대로 |
| sim Flow-Matching | 🔄 kanu GPU 1에서 진행 중(100k, ~20:40 종료) | 10k 4/20 (CPU, Euler 10스텝 — 실기 서버 기본 100스텝과 다름) · 이후 나오는 대로 |
