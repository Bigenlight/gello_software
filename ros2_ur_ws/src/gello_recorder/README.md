...
| 환경변수 | 기본값 | 설명 |
|---|---|---|
| `CAM1_SERIAL` | `147122072740` | 카메라 #1 시리얼 (plain D435) |
| `CAM2_SERIAL` | `243222072700` | 카메라 #2 시리얼 (D435IF) |
...
예: `CAM1_SERIAL=147122072740 CAMERA_WARMUP_S=6 ros2 run gello_recorder gello_recorder_gui`
